            ...
            child: Container(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            Text('김반려', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                            Text('petlover@email.com', style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13)),
                          ],
                        ),
                      ),
                      IconButton(
                  ...
                  Row(
                    children: [
                      Expanded(child: _StatTile(icon: Icons.favorite_border, value: '42', label: '저장한 레시피')),
                      const SizedBox(width: 10),
                      Expanded(child: _StatTile(icon: Icons.emoji_events_outlined, value: '28', label: '조리 완료')),
                      const SizedBox(width: 10),
                      Expanded(child: _StatTile(icon: Icons.menu_book_outlined, value: '15', label: '작성한 리뷰')),
                    ],
                  ),
                ],
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...kUserPets.map((pet) => _PetRow(pet: pet)),
                    ],
                  ),
                ),
              ),
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: SizedBox(
                        width: 80,
                        height: 80,
                        child: ChowNetworkImage(url: pet.image),
                      ),
                    ),
                    Positioned(
                      right: -4,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(pet.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: ChowColors.gray800)),
                                Text('${pet.breed} • ${pet.age}', style: const TextStyle(fontSize: 13, color: ChowColors.gray500)),
                              ],
                            ),
                          ),
                      ...
                      const SizedBox(height: 8),
                      Text('체중: ${pet.weight}', style: const TextStyle(fontSize: 11, color: ChowColors.gray600)),
                      Text('알러지: ${pet.allergies.join(", ")}', style: const TextStyle(fontSize: 11, color: ChowColors.orange600)),
                    ],
                  ),
                ),
              ],
