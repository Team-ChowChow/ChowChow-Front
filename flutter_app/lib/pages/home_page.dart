...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _autoTimer = Timer.periodic(const Duration(seconds: 3), (_) {
      ...
      final next = (_slideIndex + 1) % kTrendingRecipes.length;
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: PageView.builder(
                        ...
                        itemCount: kTrendingRecipes.length,
                        onPageChanged: (i) => setState(() => _slideIndex = i),
                        itemBuilder: (context, i) {
                          final r = kTrendingRecipes[i];
                          return Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 12),
                            child: _TrendingCard(recipe: r),
                          );
                        },
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: List.generate(kTrendingRecipes.length, (i) {
                    ...
                    Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: kMealPhotos.length,
                        itemBuilder: (context, i) => _MealCard(meal: kMealPhotos[i]),
                      ),
                    ),
                    const SizedBox(height: 12),
                    Padding(
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          ChowNetworkImage(url: recipe.image),
          DecoratedBox(
            decoration: BoxDecoration(
        ...
        children: [
          Expanded(
            child: Stack(
              fit: StackFit.expand,
              children: [
                ChowNetworkImage(url: meal.image),
                Positioned(
                  top: 8,
                  right: 8,
                  child: Material(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(meal.date, style: const TextStyle(fontSize: 11, color: ChowColors.gray500)),
                    const Spacer(),
                    const Icon(Icons.favorite, size: 12, color: ChowColors.orange500),
                    const SizedBox(width: 2),
                    Text('${meal.likes}', style: const TextStyle(fontSize: 11, color: ChowColors.gray600)),
                  ],
                ),
              ],
            ),
